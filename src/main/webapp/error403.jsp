...
<head>
    ...
    <title>403 Forbidden — AlgaeDB</title>
...
<body>
    ...
    <div class="auth-wrapper">
        <div style="text-align:center;" class="animate-scale-in">
            <div style="font-size:6rem;font-weight:800;color:var(--destructive);line-height:1;margin-bottom:0.5rem;">403</div>
            <h1 style="font-size:1.5rem;font-weight:700;margin-bottom:0.5rem;">Access Denied</h1>
            <p style="color:var(--muted-foreground);margin-bottom:2rem;">You do not have permission to access this page.</p>

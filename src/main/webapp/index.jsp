    ...
    <div style="display:flex;flex-direction:column;min-height:calc(100vh - 3.5rem);">
        ...
        <section class="hero">
            ...
            <div class="hero-content">
                ...
                <h1 class="hero-title animate-slide-up delay-100">
                    Algae DNA <span class="hero-title-accent">Database<span class="hero-title-underline animate-shimmer"></span></span>
                </h1>
                ...
                <div class="hero-actions animate-slide-up delay-300">
                    <a href="${pageContext.request.contextPath}/explore" class="btn btn-primary animate-pulse-glow">
        ...
        <section class="features-section scroll-reveal">
            <div style="max-width:64rem;margin:0 auto;">
                ...
                <div class="features-grid scroll-reveal-stagger">
                    <div class="card-animate" style="padding:1.5rem;text-align:center;">
                        <div class="feature-icon stat-icon-primary animate-stagger-in delay-100" style="margin:0 auto 1rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
                            </svg>
                        </div>
                        <h3 class="feature-title">Advanced Search</h3>
                        <p class="feature-desc">Search by species name or DNA sequence with real-time filtering.</p>
                    </div>
                    <div class="card-animate" style="padding:1.5rem;text-align:center;">
                        <div class="feature-icon stat-icon-success animate-stagger-in delay-200" style="margin:0 auto 1rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <p class="feature-desc">Multiple catalogued microalgae species with signature sequences.</p>
                    </div>
                    <div class="card-animate" style="padding:1.5rem;text-align:center;">
                        <div class="feature-icon stat-icon-warning animate-stagger-in delay-300" style="margin:0 auto 1rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M2 15c6.667-6 13.333 0 20-6"/>
                                <path d="M9 22c1.798-1.998 2.518-3.995 2.807-5.993"/>
                                <path d="M15 2c-1.798 1.998-2.518 3.995-2.807 5.993"/>
        ...
        <section class="stats-section scroll-reveal">
            <div class="stats-grid scroll-reveal-stagger">
